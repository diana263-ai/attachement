                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/modals/success-payment.png')); ?>" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/modals/login.png')); ?>" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/modals/subscribe.png')); ?>" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="subscribe-modals-cover h-100">
                                            <img src="<?php echo e(URL::asset('assets/images/modals/auth-one-bg.jpg')); ?>" alt="" class="h-100 w-100 object-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal-content -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/modals/signup.png')); ?>" alt="Mac Image"
                                        class="img-fluid">
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/ui-modals.blade.php ENDPATH**/ ?>
                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/eur.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    EUR
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/gbp.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    GBP
                                </div>
                            </td>
                            <td class="form_name">Wallet</td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/jpy.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    JPY
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/xpm.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    XPM
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ppt.svg')); ?>" alt="" class="avatar-xxs me-2">
                                    PPT
                                </div>
                            </td>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('/assets/js/pages/crypto-transactions.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-crypto-transactions.blade.php ENDPATH**/ ?>
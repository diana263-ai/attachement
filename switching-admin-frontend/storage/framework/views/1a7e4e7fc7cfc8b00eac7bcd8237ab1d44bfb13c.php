                            ...
                            <div class="product-img-slider sticky-side-div">
                                <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <img src="<?php echo e(URL::asset('assets/images/products/img-6.png')); ?>" alt=""
                                                class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="<?php echo e(URL::asset('assets/images/products/img-1.png')); ?>" alt=""
                                                class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="<?php echo e(URL::asset('assets/images/products/img-8.png')); ?>" alt=""
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="#" class="d-block">
                                                                        <img src="<?php echo e(URL::asset('assets/images/small/img-12.jpg')); ?>"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-cover">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img src="<?php echo e(URL::asset('assets/images/small/img-11.jpg')); ?>"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-cover">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img src="<?php echo e(URL::asset('assets/images/small/img-10.jpg')); ?>"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-cover">
                                                                    </a>
                                                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-ecommerce-product-details.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Live Auction'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> NFT Marketplace <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?>Live Auction <?php $__env->endSlot(); ?>
    ...
    <div class="col-xxl-9">
        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-1.gif')); ?>" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-5.gif')); ?>" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    <div class="position-relative rounded overflow-hidden">
                        <img src="<?php echo e(URL::asset('assets/images/nft/img-06.jpg')); ?>" alt="" class="card-img-top explore-img">
                        <div class="discount-time">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-4.gif')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-3.gif')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/nft/img-04.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/nft/img-05.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/nft/img-02.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-10.jp')); ?>g" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
...
<script src="<?php echo e(URL::asset('/assets/js/pages/apps-nft-auction.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-nft-auction.blade.php ENDPATH**/ ?>
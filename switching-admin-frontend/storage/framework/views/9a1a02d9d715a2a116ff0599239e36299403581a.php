            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form id="logout-form" action="<?php echo e(route('login')); ?>" method="GET" style="display: none;">
                            <?php echo csrf_field(); ?>
                        </form>
                    </div>
                </div>
...
</header><?php /**PATH /home/vinscent/Desktop/NMB SWITCH/card-admin-v2/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>
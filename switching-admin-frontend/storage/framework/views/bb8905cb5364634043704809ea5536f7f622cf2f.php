<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Listjs'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Listjs <?php $__env->endSlot(); ?>
                            ...
                            <ul class="list list-group list-group-flush mb-0">
                                <li class="list-group-item" data-id="1">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt="" src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item" data-id="2">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt="" src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item" data-id="3">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt="" src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item" data-id="4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <img class="image avatar-xs rounded-circle" alt="" src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/tables-listjs.blade.php ENDPATH**/ ?>
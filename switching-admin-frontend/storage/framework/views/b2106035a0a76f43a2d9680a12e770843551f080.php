            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <?php break; ?>
                        <?php case ('fr'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/french.svg')); ?>" class="rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php case ('gr'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/germany.svg')); ?>" class="rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php default: ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-6.png')); ?>"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
...
<?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>
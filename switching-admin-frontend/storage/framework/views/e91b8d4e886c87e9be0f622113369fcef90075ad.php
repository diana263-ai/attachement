<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.buy-sell'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('css'); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> Crypto <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> Buy & Sell <?php $__env->endSlot(); ?>
                                ...
                                <div class="d-flex flex-wrap gap-4 align-items-center">
                                    <div>
                                        ...
                                        <p class="text-muted text-uppercase fw-medium mb-0">Bitcoin
                                            (BTC) <small class="badge badge-soft-success"><i
                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/xmr.svg')); ?>" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/sol.svg')); ?>" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ant.svg')); ?>" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/fil.svg')); ?>" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/aave.svg')); ?>" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ada.svg')); ?>" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/dot.svg')); ?>" alt=""
                                        class="avatar-xxs me-2">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('/assets/js/pages/crypto-buy-sell.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-crypto-buy-sell.blade.php ENDPATH**/ ?>
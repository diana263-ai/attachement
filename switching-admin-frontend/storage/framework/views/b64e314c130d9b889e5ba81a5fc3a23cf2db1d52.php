                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2" style="cursor:context-menu;">
                                ...
                                <p class="text-muted">Sign in to continue to Fuel card System.</p>
                            </div>
                            <div class="p-2 mt-4">
                                <form action="<?php echo e(route('home.index2')); ?>" method="POST">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/card-admin-v2/resources/views/auth/login.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.sweet-alerts'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> ScrollSpy <?php $__env->endSlot(); ?>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/success-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/error-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/warning-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/join-community.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/email-verify.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('assets/images/sweetalert2/notification-message.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/advance-ui-sweetalerts.blade.php ENDPATH**/ ?>
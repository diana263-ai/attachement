...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Invoice Action'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->slot('li_1'); ?> Email <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?>Ecommerce Action <?php $__env->endSlot(); ?>
                            ...
                            <tr style="font-family: 'Roboto', sans-serif; font-size: 14px; margin: 0;">
                                <td class="content-wrap" style="font-family: 'Roboto', sans-serif; box-sizing: border-box; color: #495057; font-size: 14px; vertical-align: top; margin: 0;box-shadow: 0 3px 15px rgba(30,32,37,.06); ;border-radius: 7px; background-color: #fff;overflow: hidden;" valign="top">
                                    ...
                                    <div style="padding: 20px;box-sizing: border-box; text-align: center; border-bottom: 1px solid #e9ebec;">
                                        <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" alt="" height="23">
                                    </div>
                                            ...
                                            <tbody>
                                                <tr style="text-align: left;">
                                                    <th style="padding: 5px;width: 110px;">
                                                        <img src="<?php echo e(URL::asset('assets/images/products/img-3.png')); ?>" alt="" height="80">
                                                    </th>
                                                    <th style="padding: 5px;">
                                                ...
                                                <tr style="text-align: left;">
                                                    <th style="padding: 5px;width: 110px;">
                                                        <img src="<?php echo e(URL::asset('assets/images/products/img-2.png')); ?>" alt="" height="80">
                                                    </th>
                                                    <th style="padding: 5px;">
                                                ...
                                                <tr style="text-align: left;">
                                                    <th style="padding: 5px;width: 110px;">
                                                        <img src="<?php echo e(URL::asset('assets/images/products/img-1.png')); ?>" alt="" height="80">
                                                    </th>
                                                    <th style="padding: 5px;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-email-ecommerce.blade.php ENDPATH**/ ?>
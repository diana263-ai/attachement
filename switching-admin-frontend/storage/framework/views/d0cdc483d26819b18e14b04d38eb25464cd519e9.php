                    ...
                    <div class="live-preview">
                        <div>
                            <div>
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded" alt="rounded">
                                        <p><code>.rounded</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-top" alt="rounded-top">
                                        <p><code>.rounded-top</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-end" alt="rounded-end">
                                        <p><code>.rounded-end</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-bottom" alt="rounded-bottom">
                                        <p><code>.rounded-bottom</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-start" alt="rounded-start">
                                        <p><code>.rounded-start</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-circle" alt="rounded-circle">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" class="avatar-md w-auto rounded-pill" alt="rounded-pill">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-start flex-wrap gap-4">
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-0" alt="rounded-0">
                                        <p><code>.rounded-0</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-1" alt="rounded-1">
                                        <p><code>.rounded-1</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-2" alt="rounded-2">
                                        <p><code>.rounded-2</code></p>
                                    </div>
                                    <div class="text-center">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-3" alt="rounded-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/ui-utilities.blade.php ENDPATH**/ ?>
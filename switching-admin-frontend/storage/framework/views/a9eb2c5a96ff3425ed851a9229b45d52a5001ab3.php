                                    ...
                                    <div class="col-md-auto">
                                        <div class="avatar-md">
                                            <div class="avatar-title bg-white rounded-circle">
                                                <img src="<?php echo e(URL::asset('assets/images/brands/slack.png')); ?>" alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        ...
                                        <div class="d-flex mb-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-10.jpg')); ?>" alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="row g-2 mb-3">
                                                    <div class="col-lg-1 col-sm-2 col-6">
                                                        <img src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" alt=""
                                                            class="img-fluid rounded">
                                                    </div>
                                                    <div class="col-lg-1 col-sm-2 col-6">
                                                        <img src="<?php echo e(URL::asset('assets/images/small/img-5.jpg')); ?>" alt=""
                                                            class="img-fluid rounded">
                                                    </div>
                                                </div>
                                                <a href="javascript: void(0);" class="badge text-muted bg-light"><i
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-4">
                                                <div class="row border border-dashed gx-2 p-2 mb-2">
                                                    ...
                                                    <!--end col-->
                                                    <div class="col-4">
                                                        <img src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" alt=""
                                                            class="img-fluid rounded" />
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-projects-overview.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.NFT-Dashboard'); ?> <?php $__env->stopSection(); ?>
            ...
            <div class="col-xl-6">
                <div class="card overflow-hidden">
                    <div class="card-body bg-marketplace d-flex">
                        ...
                        <img src="<?php echo e(URL::asset('assets/images/bg-d.png')); ?>" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
            <!--end col-->
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xxl-4">
                                <div class="border-start p-4 h-100 d-flex flex-column">
                                    ...
                                    <div class="w-100">
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-2.gif')); ?>" class="img-fluid avatar-xs rounded-circle object-cover" alt="">
                    ...
                    <div data-simplebar style="max-height: 365px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-10.jpg')); ?>" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-01.jpg')); ?>" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-04.jpg')); ?>" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-06.jpg')); ?>" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-05.jpg')); ?>" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                                            <h6 class="fs-14 mb-1">Timothy Smith</h6>
                                        </a>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        ...
                        <div class="explore-place-bid-img">
                            <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-3.gif')); ?>" alt="" class="img-fluid card-img-top explore-img" />
                ...
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        ...
                        <div class="explore-place-bid-img">
                            <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="img-fluid card-img-top explore-img" />
                            <div class="bg-overlay"></div>
                            <div class="place-bid-btn">
                                <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        ...
                        <div class="explore-place-bid-img">
                            <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-1.gif')); ?>" alt="" class="img-fluid card-img-top explore-img" />
                            <div class="bg-overlay"></div>
                            <div class="place-bid-btn">
                                <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        ...
                        <div class="explore-place-bid-img">
                            <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-4.gif')); ?>" alt="" class="img-fluid card-img-top explore-img" />
                            <div class="bg-overlay"></div>
                            <div class="place-bid-btn">
                                <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                            </div>
                        ...
                        <table class="table table-borderless align-middle">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-01.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-02.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-04.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-05.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-06.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-5.gif')); ?>" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-01.jpg')); ?>" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1"><a href="apps-nft-item-details">Abstract Face Painting</a></h6>
                                            <p class="text-muted mb-0"> Artworks</p>
                                        </div>
                                    </div>
                                </td>
                                <td><img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/btc.svg')); ?>" class="avatar-xxs me-2" alt="">48,568.025</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-5.gif')); ?>" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <td><img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ltc.svg')); ?>" class="avatar-xxs me-2" alt="">87,142.027</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-06.jpg')); ?>" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1"><a href="apps-nft-item-details">Robotic Body Art</a></h6>
                                            <p class="text-muted mb-0">Photography</p>
                                        </div>
                                    </div>
                                </td>
                                <td><img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/etc.svg')); ?>" class="avatar-xxs me-2" alt="">33,847.961</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-04.jpg')); ?>" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1"><a href="apps-nft-item-details">Smillevers Crypto</a></h6>
                                            <p class="text-muted mb-0">Artworks</p>
                                        </div>
                                    </div>
                                </td>
                                <td><img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/dash.svg')); ?>" class="avatar-xxs me-2" alt="">73,654.421</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1"><a href="apps-nft-item-details">Creative Filtered Portrait</a></h6>
                                            <p class="text-muted mb-0"> 3d Style</p>
                                        </div>
                                        <div class="flex-grow-1"></div>
                                    </div>
                                </td>
                                <td><img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/bnb.svg')); ?>" class="avatar-xxs me-2" alt="">66,742.077</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="<?php echo e(URL::asset('assets/images/nft/img-02.jpg')); ?>" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <td><img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/usdt.svg')); ?>" class="avatar-xxs me-2" alt="">34,736.209</td>
                                <td>
    ...
    <div class="col-xxl-3 col-lg-6">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                ...
                <div class="mt-1">
                    <p class="mb-1"><img src="<?php echo e(URL::asset('assets/images/flags/us.svg')); ?>" alt="" height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                    <p class="mb-1"><img src="<?php echo e(URL::asset('assets/images/flags/russia.svg')); ?>" alt="" height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                    <p class="mb-1"><img src="<?php echo e(URL::asset('assets/images/flags/spain.svg')); ?>" alt="" height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                    <p class="mb-1"><img src="<?php echo e(URL::asset('assets/images/flags/italy.svg')); ?>" alt="" height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                    <p class="mb-0"><img src="<?php echo e(URL::asset('assets/images/flags/germany.svg')); ?>" alt="" height="15" class="rounded me-2"> Germany <span class="float-end">5%</span></p>
                </div>
            </div>
            <!-- end card body -->
        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" height="220" class="object-cover w-100" />
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="<?php echo e(URL::asset('assets/images/nft/img-04.jpg')); ?>" alt="" height="220" class="object-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-5.gif')); ?>" alt="" height="220" class="object-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="<?php echo e(URL::asset('assets/images/nft/img-06.jpg')); ?>" alt="" height="220" class="object-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
                ...
                <div class="swiper collection-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-02.jpg')); ?>" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-01.jpg')); ?>" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-04.jpg')); ?>" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile">
...
<!-- Marketplace init -->
<script src="<?php echo e(URL::asset('assets/js/pages/dashboard-nft.init.js')); ?>"></script>

<script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/dashboard-nft.blade.php ENDPATH**/ ?>
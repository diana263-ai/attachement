<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.buttons'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> Base UI <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> Buttons <?php $__env->endSlot(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button"
                                class="btn btn-secondary waves-effect waves-light">Secondary</button>
                            <button type="button"
                    ...
                    <div class="d-none code-view">
                        <pre class="language-markup"
                            style="height: 275px;"><code>&lt;!-- Base Buttons --&gt;
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button"
                                class="btn btn-outline-light waves-effect">Light</button>
                        </div>
                    </div>
                    <div class="d-none code-view">
                        <pre class="language-markup"
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button"
                                class="btn rounded-pill btn-secondary waves-effect">Secondary</button>
                            <button type="button"
                            ...
                            <button type="button"
                                class="btn rounded-pill btn-light waves-effect">Light</button>
                        </div>
                    </div>
                    <div class="d-none code-view">
                        <pre class="language-markup"
                            style="height: 275px;"><code>&lt;!-- Rounded Buttons --&gt;
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button"
                                class="btn btn-soft-success waves-effect waves-light">Success</button>
                            <button type="button"
                                class="btn btn-soft-info waves-effect waves-light">Info</button>
                            <button type="button"
                                class="btn btn-soft-warning waves-effect waves-light">Warning</button>
                            <button type="button"
                                class="btn btn-soft-danger waves-effect waves-light">Danger</button>
                            <button type="button"
                                class="btn btn-soft-dark waves-effect waves-light">Dark</button>
                        </div>
                    </div>
                    <div class="d-none code-view">
                        <pre class="language-markup"
                            style="height: 275px;"><code>&lt;!-- Soft Buttons --&gt;
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button"
                                class="btn btn-ghost-primary waves-effect waves-light">Primary</button>
                            <button type="button"
                                class="btn btn-ghost-secondary waves-effect waves-light">Secondary</button>
                            <button type="button"
                                class="btn btn-ghost-success waves-effect waves-light">Success</button>
                            <button type="button"
                                class="btn btn-ghost-info waves-effect waves-light">Info</button>
                            <button type="button"
                                class="btn btn-ghost-warning waves-effect waves-light">Warning</button>
                            <button type="button"
                                class="btn btn-ghost-danger waves-effect waves-light">Danger</button>
                            <button type="button"
                                class="btn btn-ghost-dark waves-effect waves-light">Dark</button>
                        </div>
                    </div>
                    <div class="d-none code-view">
                        <pre class="language-markup"
                            style="height: 275px;"><code>&lt;!-- ghost Buttons --&gt;
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button"
                                class="btn btn-info bg-gradient waves-effect waves-light">Info</button>
                            <button type="button"
                            ...
                            <button type="button"
                                class="btn btn-dark bg-gradient waves-effect waves-light">Dark</button>
                            <button type="button"
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button"
                                class="btn btn-warning btn-animation waves-effect waves-light"
                            ...
                            <button type="button"
                                class="btn btn-dark btn-animation waves-effect waves-light"
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                    ...
                                    <button type="button"
                                        ...
                                        Success</button>
                                    <button type="button"
                                        class="btn btn-warning btn-label rounded-pill"><i
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex flex-wrap gap-2">
                                    <button type="button" class="btn btn-primary btn-label right"><i
                                        ...
                                        Primary</button>
                                    <button type="button"
                                        class="btn btn-success btn-label right rounded-pill"><i
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button"
                                class="btn btn-primary w-xs waves-effect waves-light">Xs</button>
                            <button type="button"
                                class="btn btn-danger w-sm waves-effect waves-light">Small</button>
                            <button type="button"
                                class="btn btn-warning w-md waves-effect waves-light">Medium</button>
                            <button type="button"
                                class="btn btn-success w-lg waves-effect waves-light">Large</button>
                        </div>
                    </div>
                    <div class="d-none code-view">
                        <pre class="language-markup">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/ui-buttons.blade.php ENDPATH**/ ?>
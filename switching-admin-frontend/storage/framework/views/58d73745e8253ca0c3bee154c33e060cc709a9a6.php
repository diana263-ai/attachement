<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.sellers'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Ecommerce <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?>Sellers  <?php $__env->endSlot(); ?>
...
<div class="row mt-4">
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <img src="<?php echo e(URL::asset('assets/images/companies/img-1.png')); ?>" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="<?php echo e(URL::asset('assets/images/companies/img-2.png')); ?>" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="<?php echo e(URL::asset('assets/images/companies/img-3.png')); ?>" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                <img src="<?php echo e(URL::asset('assets/images/companies/img-4.png')); ?>" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="<?php echo e(URL::asset('assets/images/companies/img-5.png')); ?>" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                <img src="<?php echo e(URL::asset('assets/images/companies/img-6.png')); ?>" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                <img src="<?php echo e(URL::asset('assets/images/companies/img-7.png')); ?>" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="<?php echo e(URL::asset('assets/images/companies/img-8.png')); ?>" alt="" height="45">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-ecommerce-sellers.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.deals'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        ...
        <div class="col">
            <div class="card">
                <a class="card-body bg-soft-success" data-bs-toggle="collapse" href="#contactInitiated" role="button"
            ...
            <div class="collapse show" id="contactInitiated">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated2"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/brands/github.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="collapse border-top border-top-dashed" id="contactInitiated2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Zoetic Fashion <small class="badge badge-soft-warning">25
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="contactInitiated3">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Micro Design <small class="badge badge-soft-success">2
                                    Month</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated4"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-7.jpg')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated5"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/brands/mail_chimp.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="collapse show" id="needsIdentified">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Alexis Clarke <small class="badge badge-soft-danger">7 Days</small>
                            </h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Meta4Systems <small class="badge badge-soft-warning">35
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified3"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/brands/dribbble.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified3">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Syntyce Solutions <small class="badge badge-soft-danger">15
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-6.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified6">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">iTest Factory <small class="badge badge-soft-warning">42
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified7">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Meta4Systems <small class="badge badge-soft-success">6
                                    Month</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged1"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-5.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="collapse border-top border-top-dashed" id="meetingArranged1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-danger">10
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged3"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-8.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
        ...
        <div class="col">
            <div class="card">
                <a class="card-body bg-soft-secondary" data-bs-toggle="collapse" href="#offerAccepted" role="button"
            ...
            <div class="collapse show" id="offerAccepted">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/brands/slack.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-warning">47
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted4">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-success">4
                                    Month</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted5" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-3.png')); ?>" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted6">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-danger">14
                                    Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('/assets/js/pages/crm-deals.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('assets/libs/sweetalert2/sweetalert2.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-crm-deals.blade.php ENDPATH**/ ?>
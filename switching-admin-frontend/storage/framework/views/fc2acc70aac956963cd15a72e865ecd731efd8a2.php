...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Item Details'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Pages <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?>Item Details <?php $__env->endSlot(); ?>
                    ...
                    <div class="card ribbon-box border shadow-none right">
                        ...
                        <div class="position-absolute bottom-0 p-3">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-3.gif')); ?>" alt="" class="img-fluid rounded h-100 object-cover">
                                </div>
                                <div class="col-3">
                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/nft/img-01.jpg')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <a href="apps-nft-item-details.html" class="link-dark"><span class="mb-0 ms-2">Brave Tigers NFT</span></a>
                                                    </div>
                                                </th>
                                                <td>0.235 ETH</td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <a href="apps-nft-item-details.html" class="link-dark"><span class="mb-0 ms-2">Creative filtered portrait</span></a>
                                                    </div>
                                                </th>
                                                <td>571.24 ETH</td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-4.gif')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <a href="apps-nft-item-details.html" class="link-dark"><span class="mb-0 ms-2">Evolved Reality</span></a>
                                                    </div>
                                                </th>
                                                <td>130.39 ETH</td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/nft/img-06.jpg')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <a href="apps-nft-item-details.html" class="link-dark"><span class="mb-0 ms-2">Robotic Body Art</span></a>
                                                    </div>
                                                </th>
                                                <td>81.72 ETH</td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                                ...
                                                <div class="border border-dashed rounded p-3">
                                                    ...
                                                    <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                        <a href="#" class="d-block">
                                                            <img src="<?php echo e(URL::asset('assets/images/small/img-12.jpg')); ?>" alt="" class="avatar-sm rounded object-cover" />
                                                        </a>
                                                        <a href="#" class="d-block">
                                                            <img src="<?php echo e(URL::asset('assets/images/small/img-11.jpg')); ?>" alt="" class="avatar-sm rounded object-cover" />
                                                        </a>
                                                        <a href="#" class="d-block">
                                                            <img src="<?php echo e(URL::asset('assets/images/small/img-10.jpg')); ?>" alt="" class="avatar-sm rounded object-cover" />
                                                        </a>
                                                    </div>
...
<script src="<?php echo e(URL::asset('/assets/js/pages/apps-nft-item-details.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-nft-item-details.blade.php ENDPATH**/ ?>
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-warning rounded p-2">
                                        <img src="<?php echo e(URL::asset('assets/images/brands/slack.png')); ?>" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="apps-projects-overview"
                                        class="text-dark">Slack brand logo design</a></h5>
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                    ...
                                    <div class="avatar-xxs">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="" class="rounded-circle img-fluid">
                                    </div>
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-danger rounded p-2">
                                        <img src="<?php echo e(URL::asset('assets/images/brands/dribbble.png')); ?>" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-success rounded p-2">
                                        <img src="<?php echo e(URL::asset('assets/images/brands/mail_chimp.png')); ?>" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="apps-projects-overview"
                                        class="text-dark">Chat Application</a></h5>
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-info rounded p-2">
                                        <img src="<?php echo e(URL::asset('assets/images/brands/dropbox.png')); ?>" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="apps-projects-overview"
                                        class="text-dark">Project App</a></h5>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview"
                                        class="text-dark">Multipurpose landing template</a></h5>
                            </div>
                            <div class="flex-shrink-0">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-warning rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview"
                                        class="text-dark">Dashboard UI</a></h5>
                            </div>
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-1 align-items-center my-n2">
                                    <button type="button" class="btn avatar-xs p-0 favourite-btn active">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-info rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview"
                                        class="text-dark">Vector Images</a></h5>
                            </div>
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-1 align-items-center my-n2">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-success rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="apps-projects-overview"
                                        class="text-dark">Authentication</a></h5>
                            </div>
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-1 align-items-center my-n2">
                                    <button type="button" class="btn avatar-xs p-0 favourite-btn active">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-secondary rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="<?php echo e(URL::asset('assets/images/brands/dribbble.png')); ?>" alt="" height="32">
                        </div>
                    </div>

                    <div class="py-3">
                        <h5 class="fs-14 mb-3"><a href="apps-projects-overview" class="text-dark">Kanban
                                Board</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="<?php echo e(URL::asset('assets/images/brands/slack.png')); ?>" alt="" height="32">
                        </div>
                    </div>
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview" class="text-dark">Ecommerce
                                app</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <div class="avatar-group">
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                    ...
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-9.jpg')); ?>" alt="" class="rounded-circle avatar-xxs">
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="top" title="James Clem">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-10.jpg')); ?>" alt="" class="rounded-circle avatar-xxs">
                                </a>
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="top" title="Add Members">
                                    <div class="avatar-xxs">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-primary rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="<?php echo e(URL::asset('assets/images/brands/dropbox.png')); ?>" alt="" height="32">
                        </div>
                    </div>

                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="apps-projects-overview" class="text-dark">Redesign -
                                Landing page</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="<?php echo e(URL::asset('assets/images/brands/mail_chimp.png')); ?>" alt="" height="32">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-projects-list.blade.php ENDPATH**/ ?>
...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <!-- <a href="index" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('assets/images/nmbz/logo-1.png')); ?>" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('assets/images/nmbz/logo-1.png')); ?>" alt="" height="35">
            </span>
        </a> -->
        <!-- Light Logo-->
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLanding">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-key="t-one-page">View</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/funds-transfer/pending-topup" class="nav-link">View All</a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH C:\Users\RAVIE\Desktop\Internship Project\switching-admin-frontend\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>
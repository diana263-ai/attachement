<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.cards'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('li_1'); ?> Base UI <?php $__env->endSlot(); ?>
        <?php $__env->slot('title'); ?> Cards <?php $__env->endSlot(); ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                ...
                <img class="img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-1">
                    ...
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
                            </div>
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-12.jpg')); ?>" alt="Card image">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-1.jpg')); ?>" alt="Card image">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-5.jpg')); ?>" alt="Card image">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-6.jpg')); ?>" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-7.jpg')); ?>" alt="Card image cap">
                    </div>
                </div><!-- end col -->
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-8.jpg')); ?>" alt="Card image cap">
                        <div class="card-footer">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-10.jpg')); ?>" alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                            </p>
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-11.jpg')); ?>" alt="Card image cap">
                        <div class="card-header">
                            <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-11.jpg')); ?>" alt="Card image cap">
                    </div>
                </div><!-- end col -->
            </div>
            ...
            <div class="row">
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="<?php echo e(URL::asset('assets/images/small/img-12.jpg')); ?>" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="<?php echo e(URL::asset('assets/images/small/img-9.jpg')); ?>" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-4">
                    <div class="card card-success">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                                </div>
                                <div class="flex-grow-1 ms-3">
        ...
        <div class="col-xxl-4">
            <div class="card card-secondary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-7.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                        </div>
                        <div class="flex-grow-1 ms-3">
        ...
        <div class="col-xxl-4">
            <div class="card card-light">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-sm rounded-circle">
                        </div>
                        <div class="flex-grow-1 ms-3">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-group">
                <div class="card mb-4">
                    <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" alt="Card image cap" />
                    <div class="card-body">
            ...
            <div class="card mb-4">
                <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-5.jpg')); ?>" alt="Card image cap" />
                <div class="card-body">
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                ...
                <img class="img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-11.jpg')); ?>" alt="Card image cap" />
                <div class="card-body">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                <img class="card-img-top img-fluid" src="<?php echo e(URL::asset('assets/images/small/img-10.jpg')); ?>" alt="Card image cap" />
                <div class="card-body">
                    <h4 class="card-title">Give your text a good structure?</h4>
                    <p class="card-text">This is a wider card with supporting text below as
                        a natural lead-in to additional content. This card has even longer
        ...
        <div class="col-sm-12">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" class="card-img-top" alt="..." />
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="<?php echo e(URL::asset('assets/images/small/img-7.jpg')); ?>" class="card-img" alt="..." />
                    </div>
                </div><!-- end col -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card p-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex position-relative">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" class="flex-shrink-0 me-3 avatar-xl rounded" alt="..." />
                                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-0 bg-light position-relative">
                                <div class="col-md-5">
                                <img src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" class="rounded-start img-fluid" alt="..." />
                                </div>
    ...
    <?php $__env->startSection('script'); ?>
        <script src="<?php echo e(URL::asset('assets/libs/masonry-layout/masonry-layout.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('assets/js/pages/card.init.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('assets/libs/prismjs/prismjs.min.js')); ?>"></script>

        <script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
    <?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/ui-cards.blade.php ENDPATH**/ ?>
            ...
            <div class="card bg-primary">
                <div class="card-body p-0">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-4">
                            <div class="px-3">
                                <img src="<?php echo e(URL::asset('assets/images/user-illustarator-1.png')); ?>" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="pages-pricing" class="text-reset text-decoration-underline"><b>Get Free
                                    Gift</b></a>
                        </div>
                    </div>
                    ...
                    <div class="px-2 py-2 mt-1">
                        ...
                        <div class="progress mt-2" style="height: 6px;">
                            <div class="progress-bar progress-bar-striped bg-primary" role="progressbar" style="width: 47%"
                                aria-valuenow="47" aria-valuemin="0" aria-valuemax="47">
                            </div>
                        </div>
                        ...
                        <div class="progress mt-2" style="height: 6px;">
                            <div class="progress-bar progress-bar-striped bg-primary" role="progressbar" style="width: 82%"
                                aria-valuenow="82" aria-valuemin="0" aria-valuemax="82">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="list-group list-group-flush border-dashed mb-0">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/btc.svg')); ?>" class="img-fluid" alt="">
                                    </span>
                                </div>
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/eth.svg')); ?>" class="img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ltc.svg')); ?>" class="img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="list-group-item px-0 pb-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/dash.svg')); ?>" class="img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/widgets.blade.php ENDPATH**/ ?>
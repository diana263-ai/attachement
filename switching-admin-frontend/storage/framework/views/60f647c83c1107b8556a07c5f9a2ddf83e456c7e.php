                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="<?php echo e(URL::asset('assets/images/zuva/whitezuva.png')); ?>" alt="logo" height="100">
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="p-2">
                                <form>
                                    ...
                                    <div class="text-center mt-4">
                                        <button class="btn w-100 button-custom" type="submit">Send Reset Link</button>
                                    </div>
                                </form><!-- end form -->
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\php_laravel\card-admin-v2\resources\views/auth-pass-reset-basic.blade.php ENDPATH**/ ?>
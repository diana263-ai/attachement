...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Wallet Connect'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> NFT Marketplace <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?>Wallet Connect <?php $__env->endSlot(); ?>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="<?php echo e(URL::asset('assets/images/nft/wallet/metamask.png')); ?>" alt="" height="55" class="mb-3 pb-2">
                <h5>Metamask</h5>
...
<div class="row justify-content-center">
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="<?php echo e(URL::asset('assets/images/nft/wallet/coinbase.png')); ?>" alt="" height="55" class="mb-3 pb-2">
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="<?php echo e(URL::asset('assets/images/nft/wallet/kukai.png')); ?>" alt="" height="55" class="mb-3 pb-2">
                <h5>Kukai Wallet</h5>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="<?php echo e(URL::asset('assets/images/nft/wallet/binance.png')); ?>" alt="" height="55" class="mb-3 pb-2">
                <h5>Binance</h5>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="<?php echo e(URL::asset('assets/images/nft/wallet/enjin.png')); ?>" alt="" height="55" class="mb-3 pb-2">
                <h5>Enjin Wallet</h5>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="<?php echo e(URL::asset('assets/images/nft/wallet/alpha.png')); ?>" alt="" height="55" class="mb-3 pb-2">
                <h5>Alpha Wallet</h5>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="<?php echo e(URL::asset('assets/images/nft/wallet/math.png')); ?>" alt="" height="55" class="mb-3 pb-2">
                <h5>Math Wallet</h5>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-nft-wallet.blade.php ENDPATH**/ ?>
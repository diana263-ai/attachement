                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/eth.svg')); ?>" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/mkr.svg')); ?>" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/yfi.svg')); ?>" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td class="currency_name">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/dash.svg')); ?>" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td class="currency_name">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/neo.svg')); ?>" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td class="currency_name">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/mln.svg')); ?>" alt="" class="avatar-xxs" />
                                        </div>
...
<script src="<?php echo e(URL::asset('/assets/js/pages/crypto-orders.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vinscent/Documents/poscloud/themeforest-gERV9z9D-velzon-aspnet-core-admin-dashboard-template/Velzon_v1.9.0/Laravel (1)/default/resources/views/apps-crypto-orders.blade.php ENDPATH**/ ?>
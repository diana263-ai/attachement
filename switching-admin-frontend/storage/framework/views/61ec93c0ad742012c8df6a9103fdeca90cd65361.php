                                           ...
                                           <?php echo $__env->make('merchants.modals.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li class="dropdown-divider"></li>
                                                    <li><a class="dropdown-item" href="<?php echo e(route('devices.add',[$record->id])); ?>">
                                                            <i class="ri-eye-fill align-bottom me-2 text-muted"></i>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RAVIE\Desktop\Internship Project\switching-admin-frontend\resources\views/merchants/index.blade.php ENDPATH**/ ?>